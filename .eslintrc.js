module.exports = {
  ...
  parserOptions: {
    project: ["./tsconfig.json", "./sites/public/tsconfig.json"],
  ...
  rules: {
    ...
    // These rules catch various usecases of variables typed as "any", since they won't be flagged by the TS
    ...
    "@typescript-eslint/no-explicit-any": "off", // Just for the takehome :)
