...
const rivendellAmiChart: AmiChartCreateDto = {
...
const rivendellApplicationMethods: Array<ApplicationMethodSeedType> = [
  {
...
export class ListingRivendellSeed extends ListingDefaultSeed {
  async seed() {
    ...
    const amiChart = await this.amiChartRepository.save(rivendellAmiChart)
    ...
    > = {
      ...
      applicationMethods: rivendellApplicationMethods,
      events: [],
    }
